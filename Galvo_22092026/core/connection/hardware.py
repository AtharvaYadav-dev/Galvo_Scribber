...
class HardwareConnection(BaseConnection):
    ...
    def __init__(self):
        ...
        self.enable_calibration = False # Bypass calibration by default
    ...
    def _setup_signatures(self):
        ...
        if hasattr(self.dll, 'GT_PROSYS_U3_get_di_bit'):
            self.dll.GT_PROSYS_U3_get_di_bit.argtypes = [c_short]
    ...
    def get_di_bit(self, io_pin):
        if self.dll and hasattr(self.dll, 'GT_PROSYS_U3_get_di_bit'):
            try:
                return self.dll.GT_PROSYS_U3_get_di_bit(c_short(io_pin))
            except Exception as e:
