...
class WidgetManger():
    def __init__(self):
        self.widget_methods = {"QLineEdit" : {"get" : lambda w : w.text(),
                               ...
                               "QTextEdit" : {"get" : lambda w : w.toPlainText(),
                                              "set" : lambda w, arg : w.setText(arg),
                                              "enable" : lambda w, arg : w.setEnabled(arg),
                                              "clear" : lambda w : w.clear(),
...
class WidgetHandler():
    ...
    def _buildMethods(self):
        ...
        self.methods["QLineEdit"]["readonly"] = ("setReadOnly", True)
        self.methods["QLineEdit"]["writable"] = ("setReadOnly", False)
        self.methods["QLineEdit"]["tooltip"] = "setToolTip"
        
        # QTextEdit widgets method names
        self.methods["QTextEdit"] = {}
        self.methods["QTextEdit"]["get"] = "toPlainText"
        ...
        self.methods["QTextEdit"]["readonly"] = ("setReadOnly", True)
        self.methods["QTextEdit"]["writable"] = ("setReadOnly", False)
